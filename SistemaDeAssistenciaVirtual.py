...
if texto == "abrir perfil do Dev":
    mensagem = "Abrindo o perfil do meu Desenvolvedor..."
    print(mensagem)
    #gera uma voz lendo a mensagem
    engine.say(mensagem)
    #executa e espera terminar
    engine.runAndWait()
    #abre a página da previsão do tempo desta semana 
    webbrowser.open("https://www.linkedin.com/in/pedro-rodrigues-salom%C3%A3o-55a0ab310/")
